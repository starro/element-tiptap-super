  ...
  <div>
    ...
    >
      <div class="el-tiptap-popper__menu">
        ...
        >
          <span>{{
            t('editor.extensions.Table.buttons.add_column_after')
          }}</span>
        </div>
        ...
        <div
          :class="{
            'el-tiptap-popper__menu__item--disabled': !enableMergeCells,
          }"
          class="el-tiptap-popper__menu__item"
          @mousedown="hidePopover"
        ...
        <div
          :class="{
            'el-tiptap-popper__menu__item--disabled': !enableSplitCell,
          }"
          class="el-tiptap-popper__menu__item"
          @mousedown="hidePopover"
...
export default defineComponent({
  ...
  methods: {
    createTable({ row, col }: { row: number; col: number }): void {
      const tablObj = this.editor.commands.insertTable({
        rows: row,
        cols: col,
        withHeaderRow: true,
      });
      console.log('tablObj', tablObj);
